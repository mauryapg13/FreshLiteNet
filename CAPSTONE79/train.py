...
from dataset import get_stratified_splits, get_train_transforms, get_val_transforms, TomatoDataset
...
def train_model(model_name, mode, epochs=100, batch_size=32, lr=1e-4, device=None, 
    ...
    model_filename = f"{model_name}_{mode}{'_' + run_id if run_id else ''}.pth"
